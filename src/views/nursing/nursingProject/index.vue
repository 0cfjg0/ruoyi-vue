  ...
  <div class="app-container">
    ...
    <el-row :gutter="50" class="mb8">
      <el-col :span="3" :offset="21">
        <el-button type="primary" plain icon="Plus" @click="handleAdd"
          v-hasPermi="['nursing:nursingProject:add']">新增护理项目</el-button>
      </el-col>
    </el-row>

    <el-table v-loading="loading" :data="nursingProjectList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template #default="scope">
          <el-button link type="primary" icon="Edit" @click="handleUpdate(scope.row)"
            v-hasPermi="['nursing:nursingProject:edit']" >修改</el-button>
          <el-button link type="primary" icon="Delete" @click="handleDelete(scope.row)"
            v-hasPermi="['nursing:nursingProject:remove']" >删除</el-button>
    ...
    <el-dialog :title="title" v-model="open" width="500px" append-to-body>
      <el-form ref="nursingProjectRef" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="状态" prop="status" >
        <el-select v-model="form.status" placeholder="请选择" style="width: 240px" clearable>
        <el-option
        v-for="item in nursing_project_status"
        :key="item.value"
        :label="item.label"
...
import { listNursingProject, getNursingProject, delNursingProject, addNursingProject, updateNursingProject } from "@/api/nursing/nursingProject";
...
function handleExport() {
  proxy.download('nursing/nursingProject/export', {
    ...queryParams.value
